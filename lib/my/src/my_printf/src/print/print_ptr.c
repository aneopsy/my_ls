/*
** print_ptr.c for printf in /home/theis_p/my_printf
**
** Made by theis_p
** Login   <theis_p@epitech.net>
**
** Started on  Sat Nov  7 15:56:58 2015 theis_p
** Last update Sat Nov  7 15:56:59 2015 theis_p
*/
		   ...
		   unsigned int s_to_add, unsigned int s_to_print)
{
  ...
  else if (params->width >= (int)s_to_print)
    add_space(s_to_add);
  if (params->less == 0)
  {
